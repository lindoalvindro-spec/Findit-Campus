...
const Home = () => {
 ...
 <div className="block bg-surface/80 border border-outline-variant/60 shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-3xl p-5 backdrop-blur-md relative z-10 w-full">
 ...
 className="block bg-surface/80 border border-outline-variant/60 shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-3xl p-5 backdrop-blur-md relative z-10 hover:border-primary/50 transition-all group/card cursor-pointer"
 >
 <div className="flex items-center justify-between mb-4 border-b border-outline-variant/30 pb-3">
 <div className="flex items-center gap-2">
 ...
 <div className="block bg-surface/80 border border-outline-variant/60 shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-3xl p-5 backdrop-blur-md relative z-10 w-[340px]">
 <div className="flex items-center justify-between mb-4 border-b border-outline-variant/30 pb-3">
 <div className="flex items-center gap-2">
 ...
 >
 <div className="text-headline-lg font-bold text-outline/25 group-hover:text-primary group-hover:drop-shadow-[0_0_12px_rgba(0,40,142,0.8)] group-hover:scale-110 select-none absolute top-6 right-8 transition-all duration-300">
 01
 </div>
 <motion.div 
 ...
 >
 <div className="text-headline-lg font-bold text-outline/25 group-hover:text-secondary group-hover:drop-shadow-[0_0_12px_rgba(0,108,74,0.8)] group-hover:scale-110 select-none absolute top-6 right-8 transition-all duration-300">
 02
 </div>
 <motion.div 
 whileHover={{ scale: 1.1, rotate: -5 }}

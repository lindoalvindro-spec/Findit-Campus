...
const Footer = () => {
 ...
 label: 'Share', 
 onClick: handleShare,
 hoverClass: 'hover:text-primary hover:border-primary hover:bg-primary/5 '
 }
 ];
 ...
 <p className="font-body-md text-body-md text-on-surface-variant max-w-[360px] leading-relaxed mt-2">
 ...
 <span className="material-symbols-outlined text-[22px] text-outline">group</span>
 <h3 className="font-label-md text-label-md font-semibold tracking-wide uppercase text-sm text-outline">Connect with Us!</h3>
 </div>
 ...
 whileHover={{ scale: 1.15 }}
 whileTap={{ scale: 0.9 }}
 className="w-8 h-8 rounded-full border border-outline-variant/80 flex items-center justify-center text-on-surface-variant hover:text-pink-600 hover:border-pink-500 hover:bg-pink-50 transition-all shadow-sm"
 title="Instagram"
 >
 <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">

...
const Navbar = () => {
 ...
 if (isActive) {
 return"text-primary font-bold border-b-2 border-primary pb-1 font-label-md text-label-md hover:text-primary transition-all duration-150 active:scale-95";
 }
 return"text-on-surface-variant font-medium font-label-md text-label-md hover:text-primary transition-all duration-150 active:scale-95";
 };
 ...
 className="bg-surface border-b border-outline-variant shadow-sm sticky top-0 z-50 backdrop-blur-sm bg-surface/95"
 >
 <div className="flex justify-between items-center w-full px-margin-mobile md:px-margin-desktop max-w-[1280px] mx-auto h-16">
 {/* Brand */}
 <Link to="/" className="flex items-center gap-2 font-headline-sm text-headline-sm font-bold text-primary hover:opacity-90 transition-opacity group">
 <motion.svg 
 ...
 {/* Actions */}
 <div className="flex items-center space-x-4"> <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
 ...
 className="md:hidden bg-surface border-t border-outline-variant px-margin-mobile py-4 flex flex-col gap-3 shadow-md overflow-hidden"
 >
 <Link to="/" onClick={() => setIsMobileMenuOpen(false)} className="font-label-md text-label-md text-on-surface hover:text-primary py-2 border-b border-outline-variant/30 transition-colors">Beranda</Link>
 <Link to="/lost-items" onClick={() => setIsMobileMenuOpen(false)} className="font-label-md text-label-md text-on-surface hover:text-primary py-2 border-b border-outline-variant/30 transition-colors">Barang Hilang</Link>
 <Link to="/found-items" onClick={() => setIsMobileMenuOpen(false)} className="font-label-md text-label-md text-on-surface hover:text-primary py-2 border-b border-outline-variant/30 transition-colors">Barang Ditemukan</Link>
 <Link to="/profile" onClick={() => setIsMobileMenuOpen(false)} className="font-label-md text-label-md text-on-surface hover:text-primary py-2 border-b border-outline-variant/30 transition-colors">Dasbor Laporan</Link>
